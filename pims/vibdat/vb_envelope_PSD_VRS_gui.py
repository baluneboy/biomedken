...
class vb_envelope_PSD_VRS:
    ...
    def __init__(self,parent):    
        ...
        self.master.title("vb_envelope_PSD_VRS_gui.py ver 1.0  by Tom Irvine") 
...
###############################################################################
        ...
        self.hwtext3=tk.Label(top,text='This script [self.nref-1]ulates a simplified, optimized PSD to envelope a PSD.')
