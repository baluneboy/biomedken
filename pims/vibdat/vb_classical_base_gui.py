...
class vb_classical_pulse_base:
    ...
    def __init__(self,parent): 
        ...
        self.master.title("vb_classical_base_gui.py ver 1.2  by Tom Irvine")         
        ...
        self.Lb_scale.insert(2, "G, m/sec, mm")
...
##
        ...
        if(self.n_at==0):
            ...
            vb_classical_pulse_base.classical_plot_th(self.Q,self.fn[0],\
    ...
    @classmethod       
    def classical_plot_th(cls,Q,fn,tt,acc,yb,rd,n_scale):
        
        title_string_acc='Acceleration SDOF Response fn= '+str(fn)+' Hz   Q='+str(Q)
        title_string_rd='Rel Disp  SDOF Response fn= '+str(fn)+' Hz   Q='+str(Q)        
#
        for i in range(1,200):
            if(Q==float(i)):
                title_string_acc='Acceleration SDOF Response fn= '+str(fn)+' Hz   Q='+str(i)
                title_string_rd='Rel Disp  SDOF Response fn= '+str(fn)+' Hz   Q='+str(i)                    
                break
#
        plt.close(1)
        plt.figure(1)
