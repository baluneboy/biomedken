...
class vb_arbit_force:
    def __init__(self,parent): 
        ...
        self.master.title("vb_arbit_force_gui.py ver 1.0  by Tom Irvine") 
...
#
    ...
    def trans_force(cls,self):        
        ...
        print ("\n  max = %8.4g   min = %8.4g  "    % (ft_pos,ft_neg))  
