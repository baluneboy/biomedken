...
class vb_accel_psd_syn:
    ...
    def __init__(self,parent): 
        ...
        self.master.title("vb_accel_psd_syn_gui.py ver 1.0  by Tom Irvine")         
...
###############################################################################
        ...
        if(n>max_lines):
            ...
            self.TT,self.velox=small(TTo,self.velox,K)
            print ('processing displacement plot data')
            self.TT,self.dispx=small(TTo,self.dispx,K)
        ...
        plt.figure(self.fig_num)
        self.fig_num+=1
        plt.plot(self.TT,self.velox,linewidth=1.0)
        plt.xlabel('Time(sec)')
        if(iunit==0):             
        ...
        plt.figure(self.fig_num)
        self.fig_num+=1
        plt.plot(self.TT,self.dispx,linewidth=1.0)
        plt.xlabel('Time (sec)')
        if(iunit==0):             
            plt.ylabel('Disp (in)')
...
###############################################################################
        ...
        title_string='Accleration Power Spectral Density'
        plt.title(title_string)
