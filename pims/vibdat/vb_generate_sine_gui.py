...
class vb_generate_sine:
    ...
    def __init__(self,parent): 
        ...
        self.master.title("vb_generate_sine_gui.py ver 1.7  by Tom Irvine")         
        ...
        self.phase_entry.grid(row=crow, column=1,padx=10, pady=1,sticky=tk.NW)
