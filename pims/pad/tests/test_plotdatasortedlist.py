...
class PlotDataSortedListTestCase(unittest.TestCase):
    """
    Test suite for PlotDataSortedList.
    """
    ...
    def test_init(self):
        """
        Tests the init method of the PlotDataSortedList object.
        """        
        # without maxlen kwarg input, the maxlen should be 123456
        data = PlotDataSortedList() # maxlen kwarg is missing here
        self.assertEqual(123456, data.maxlen)
        maxlen = 7654321
        data = PlotDataSortedList(maxlen=maxlen)
        self.assertEqual(maxlen, data.maxlen)

    def test_add_privacy(self):
        """
        Tests that add method of the PlotDataSortedList object raises AttributeError
        """        
    ...
    def test_append(self):
        """
        Tests the append method of the PlotDataSortedList object.
        """
        # simple test
        ...
        for maxlen in range(1, self.count+1):
            plotdata = PlotDataSortedList(maxlen=maxlen)
            for txyz in txyzs:
