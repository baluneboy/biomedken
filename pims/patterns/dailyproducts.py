...
_PADPATH_PATTERN = "(?P<ymdpath>%s/pub/pad/year(?P<year>\d{4})/month(?P<month>\d{2})/day(?P<day>\d{2}))" % _YODA
...
_BATCHPATH_PATTERN = "(?P<ymdpath>%s/www/plots/batch/year(?P<year>\d{4})/month(?P<month>\d{2})/day(?P<day>\d{2}))" % _YODA
