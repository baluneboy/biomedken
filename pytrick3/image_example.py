...
import Image, ImageEnhance, ImageFont, ImageOps, ImageDraw
import textwrap
...
def overlay_demo(fname, n_pile, n_order):
    im = Image.open('/Users/ken/Projects/pyn8/images/1024x768/' + fname)    
    mark = Image.open('/Users/ken/Projects/pyn8/images/1024x768/overlay.png')
...
def font_demo():
    ...
    x = Image.open('c:/temp/testing.png')
