...
def createTable():
    ...
    insertTextIntoCell( table, "A1", "FirstColumn1", textColor )
    insertTextIntoCell( table, "B1", "SecondColumn2", textColor )
    insertTextIntoCell( table, "C1", "ThirdColumn3", textColor )
    ...
    textFrame.setPropertyValue( "AnchorType" , 2 ) # 2nd arg = 2 for "to page" anchoring for AS_CHARACTER use 1
    ...
    textInTextFrame.insertString( cursorInTextFrame, "The first line (aka Line#1) in the newly created text frame.", 0 )
