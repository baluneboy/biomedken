...
#_PADPATH_PATTERN = "(?P<ymdpath>/misc/yoda/pub/pad/year(?P<year>\d{4})/month(?P<month>)d{2})/day(?P<day>\d{2})/))"
#_PADHEADERFILES_PATTERN = _PADPATH_PATTERN + (
#    "(?P<subdir>.*_(?P<sensor>.*))/"                                    # subdir
...
#_BATCHPATH_PATTERN = "(?P<ymdpath>/misc/yoda/www/plots/batch/year(?P<year>\d{4})/month(?P<month>)d{2})/day(?P<day>\d{2})/))"
#_BATCHROADMAPS_PATTERN = _BATCHPATH_PATTERN + (
...
if __name__ == "__main__":
    ...
    #--- THIS SHOULD NOT MATCH BECAUSE PATH YMD DOES NOT MATCH FNAME'S YMD PART (day04 versus day02)
    m = match_pattern_demo('/misc/yoda/pub/pad/year2013/month01/day04/sams2_accel_121f05006/2013_01_02_00_08_27.913-2013_01_02_01_25_23.117.121f05006.header', _PADHEADERFILES_PATTERN)
    if m:
