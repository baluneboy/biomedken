function subplotimproved(M,N,varargin);
%-------------------------------------------------------------------------
% subplotimproved function         An mproved subplot function
...
%                        'linear', default.
%                        'log'
% Example: subplotimproved(2,2,'Gap',[0.02 0.02]);
%          subplotimproved(2,3,'Gap',[0.02 0.02],'XTickL','None','YTickL','All','FontS',16);
% See also : subplotimprovedc.m
% Tested : Matlab 5.3
