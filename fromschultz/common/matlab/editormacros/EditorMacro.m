...
%    @FunctionHandle or {@FunctionHandle,arg1,...}, or any of several dozen
...
%
%    Note: Unfortunately, my Matlab 6 computer crashed since the first version
%    ^^^^  so I can no longer test EditorMacro on Matlab 6, so if you find any
%          problems please email me directly (altmany at gmail dot com)
%
...
% $Revision: 1.4 $  $Date: 2009/08/19 23:40:24 $
  ...
  try
      ...
      if isempty(appdata)
          ...
          edActionsMap = getAccelerators(hEditorPane.getActiveTextComponent);
