function specpcsarvtdaysts107(varargin);

%ex.//
%specpcsarvtdaysts107('121f03',2002,5,23,'tvis',[1 1 1],franges); % last arg bln to do [blnSpec blnPCSA blnRVT]
%specpcsarvtdaysts107('121f03',2002,5,23,'tvis',[1 0 0],franges); % just do spec
%specpcsarvtdaysts107('121f03',2002,5,23,'tvis',[0 1 0],franges); % just do pcsa
%specpcsarvtdaysts107('121f03',2002,5,23,'tvis',[1 0 1],franges); % do spec and rvt
%5 input args:
%strSensorID
%numYear
%numMonth
