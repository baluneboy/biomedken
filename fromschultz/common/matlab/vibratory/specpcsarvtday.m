function specpcsarvtday(varargin);

%ex.//
%specpcsarvtday('121f03',2002,5,23,'tvis',[1 1 1],franges); % last arg bln to do [blnSpec blnPCSA blnRVT]
%specpcsarvtday('121f03',2002,5,23,'tvis',[1 0 0],franges); % just do spec
%specpcsarvtday('121f03',2002,5,23,'tvis',[0 1 0],franges); % just do pcsa
%specpcsarvtday('121f03',2002,5,23,'tvis',[1 0 1],franges); % do spec and rvt
%5 input args:
%strSensorID
%numYear
%numMonth
