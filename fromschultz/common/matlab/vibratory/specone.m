function speccone(varargin);

%ex.//
%speccone('121f03',2002,5,23,'tvis',[1 1 1],franges); % last arg bln to do [blnSpec blnPCSA blnRVT]
%speccone('121f03',2002,5,23,'tvis',[1 0 0],franges); % just do spec
%speccone('121f03',2002,5,23,'tvis',[0 1 0],franges); % just do pcsa
%speccone('121f03',2002,5,23,'tvis',[1 0 1],franges); % do spec and rvt
%speccone('121f03','26-Jul-2002,00:00:00','26-Jul-2002,04:00:00','roadmaps');
...
iKeepFiles=find(sdnFileBegins>sdnStartGMT & sdnFileBegins<sdnStopGMT);
