function [sdnSnapped,indBmap,iCol]=batsnaptimeday(sdnInput,sdnPlotTimes,gridMin,gridMax,gridStep);
...
% $Id: batsnaptimeday.m 4160 2009-12-11 19:10:14Z khrovat $
...
if ( abs(min(diffSnap)-gridStep) > (1e-3/86400) )
   warning('used to be error that two or more input times snapped to same grid value')
end

% Chop excess slices
[sdnSnapped,iCol,j]=unique(sdnSnapped);
