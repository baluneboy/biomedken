...
%   C = INSERTROWS(A,B,IND) inserts the rows of matrix B into the matrix A
%   at the positions IND [just after IND -- read on]. Row k of matrix B
%   will be inserted after position IND(k) in the matrix A. If A is a
%   N-by-X matrix and B is a M-by-X matrix, C will be a (N+M)-by-X matrix.
%   IND can contain non-integers.
%
