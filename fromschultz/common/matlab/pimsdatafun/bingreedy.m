...
% load test data
% u = [1 4 2 1 2 3 5];  n = length(u);
% C = 6;
u = [9.96E+08 1.00E+09 1.01E+09 9.90E+08 1.10E+09 9.96E+08 1.20E+09 9.25E+08 1.40E+09 1.40E+09 1.20E+09 1.20E+09 1.10E+09 9.96E+08 7.02E+08 3.35E+08 ];  n = length(u);
C = 8.1e9;
r = C*ones(1,n);
w = zeros(n); 
