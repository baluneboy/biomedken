function [mg95,cp95,fs,mgBins,sNBIG,sNumHoursBIG,sText]=histbatday_jules(strSensor,Y,M,D,strSubdir,strTitle,blnSmall,varargin);

%histbatday_jules - analyze padhist files
%
% ex.// Y=[2001 2001];
%       M=[6 6];
%       D=[28 29];
...
%
%[mg95,cp95,fs,mgBins,sNBIG,sNumHoursBIG,sText]=histbatday_jules('121f02',2002,10,28,'padhist','Summary #2, Increment 4, Data Set #1',1,cSleep,cWake);
%[mg95,cp95,fs,mgBins,sNBIG,sNumHoursBIG,sText]=histbatday_jules('121f02',2002,10,28,'padhist','Set 02-01, Increment 4',1,cSleep,cWake);
%
...
%
%[mg95,cp95,fs,mgBins,sNBIG,sNumHoursBIG,sText]=histbatday_jules(strSensor,Y,M,D,strSubdir,strTitle,blnSmall,cSleep,cWake);

%written by: Ken Hrovat on 7/30/00
% $Id: histbatday_jules.m 4160 2009-12-11 19:10:14Z khrovat $
