function sHandles=plotspec(t,f,b,fc,fs,timechoice,timestartstr,head,mission,coord,ttl,strWhichAx,window,strWin,Nfft,No,strColormap,maxf,clim,fig);

%h=plotgen3d(t,f,b,sText,strOutType,sReport);
%
...
%Author: Ken Hrovat
% $Id: plotspec.m 4160 2009-12-11 19:10:14Z khrovat $
