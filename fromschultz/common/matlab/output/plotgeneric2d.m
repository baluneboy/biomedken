function h=plotgeneric2d(x,y,cas,strXType,strXUnits,strYType,strYUnits,casUL,casUR,strComment,strTitle,strVersion,casSides);

%plotgeneric2d - plot xy with side text
%
%h=plotgeneric2d(x,y,cas,strXType,strXUnits,strYType,strYUnits,casUL,casUR,strComment,strTitle,strVersion,casSides);
%
...
% $Id: plotgeneric2d.m 4160 2009-12-11 19:10:14Z khrovat $
...
if nargin==0
   ...
   h.handles1x1=plotgeneric2d(x,y(:,1),cas,strXType,strXUnits,strYType,strYUnits,...
      casUL,casUR,strComment,strTitle,strVersion,casSides);
   h.handles3x1=plotgeneric2d(x,y,cas,strXType,strXUnits,strYType,strYUnits,...
      casUL,casUR,strComment,strTitle,strVersion,casSides);
   return
end
