...
%	DATEAXIS(AKSIS,DATEFORM,STARTDATE) replaces axis 
%	tick labels with date labels.  AKSIS determines which 
%	axis tick labels, X, Y, or Z, should be converted.  The 
%	default AKSIS argument is 'x'.  DATEFORM specifies which  
%	date format to use.  If no DATEFORM argument is entered, 
%	this function determines the date format based on the span 
%	of the axis limits.   For example, if the difference  
%	between the axis minimum and maximum is less than 15, the 
%	tick labels will be converted to 3 letter day of the week 
%	abbreviations.  STARTDATE determines which date should be 
%	assigned to the first axis tick value.  The tick values 
%	are treated as serial date numbers.  The default STARTDATE 
%	is the lower axis limit converted to the appropriate date 
%	value.  For example, a tick value of 1 is converted to the 
%	date 01-Jan-0000.  By entering STARTDATE as '06-Apr-1995', 
%	the first tick value is assigned the date April 6, 1995 and 
%	the axis tick labels will be set accordingly. 
%      
